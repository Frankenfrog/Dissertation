...
\begin{axis}[
  ...
  height=65ex,
  font=\small,
  xmin=0.65,xmax=2.45,ymin=0.3,ymax=19.7,
  xlabel={$\CDD$ (blinded)},
  xlabel style={
        at={(ticklabel cs:1)},
        anchor=north east,
    },%
  xtick={1.0, 1.2, 1.4, 1.6, 1.8, 2.0, 2.2},
  % xticklabels={,,},
  xticklabel style={%
...
\fill[color=ClrUncert] ({rel axis cs:0,0}-|{axis cs:1.57,0}) rectangle ({rel axis cs:1.89,1}-|{axis cs:1.89,0});
% line at average value
\draw[ultra thin,color=ClrFullFit]({rel axis cs:0,0}-|{axis cs:1.73,0}) -- ({rel axis cs:1.73,1}-|{axis cs:1.73,0});
