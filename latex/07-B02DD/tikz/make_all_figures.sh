...
figs=(BDTComparison_Kpipi BDTComparison_KKpi Sensitivities_Kpipi Sensitivities_KKpi obsMass_MC DsDMass_MC obsMass_summed_pull obsTime_summed_pull_logy Acceptancespline_nolog
