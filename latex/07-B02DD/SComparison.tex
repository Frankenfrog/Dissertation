...
\begin{axis}[
  ...
  height=65ex,
  font=\small,
  xmin=-0.3,xmax=2.25,ymin=0.3,ymax=19.7,
  xlabel={$\SDD$ (blinded)},
  xlabel style={
        at={(ticklabel cs:1)},
        anchor=north east,
...
\fill[color=ClrUncert] ({rel axis cs:0,0}-|{axis cs:0.98,0}) rectangle ({rel axis cs:1.30,1}-|{axis cs:1.30,0});
% line at average value
\draw[ultra thin,color=ClrFullFit]({rel axis cs:0,0}-|{axis cs:1.14,0}) -- ({rel axis cs:1.14,1}-|{axis cs:1.14,0});
