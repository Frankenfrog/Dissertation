...
\end{align}
When depicting this triangle in the complex plane, it is convenient to scale
the triangle by dividing all side lengths by $\Vcd\Vcbs$. Then, the base
matches the real axis with length one (see
\cref{fig:cpviolation:ckmtriangle}).
\begin{figure}[htb]
\centering
\includegraphics[width=0.48\textwidth]{03-CPViolation/tikz/pdf/CKMtriangle.pdf}
