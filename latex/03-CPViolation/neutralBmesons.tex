...
\begin{align}
	\bra{\Bd}H_{\textrm{eff}}\ket{\Bdb} = \mathcal{A}(\Bdb\!\to\Bd) = \frac{g^4}{6\,\pi^2\,M_W^2}(\Vtb\Vtds)^2 B_{\Bd} F_{\Bd}^2 m_{\Bd}^2 \eta_{2B} S(x_t)\,,
...
by both \Bd and \Bdb mesons. Due to the \CPT theorem the diagonal elements of
